...
module GMO
  module Const
    ...
    API_ERROR_MESSAGES_JA = {
      ...
      'M01281002' =>	'会員IDに紐づくデフォルトカードが存在しません',
      'M01287002' =>	'会員IDに紐づく銀行口座が存在しません',
      'M01287010' =>	'会員IDに紐づく銀行口座の登録状態が不正です',
      'M01270001' =>	'自動売上ID未入力',
      'M01270002' =>	'自動売上IDが存在しません',
      'M01270010' =>	'自動売上IDがすでに存在しています',
      'M01270012' =>	'自動売上ID桁数超過',
      'M01270013' =>	'自動売上ID書式不正',
      'M01271001' =>	'利用金額未入力',
      'M01271005' =>	'利用金額桁数超過',
      'M01271006' =>	'利用金額書式不正',
      'M01271011' =>	'利用金額＋税送料が桁数超過',
      'M01283005' =>	'税送料桁数超過',
      'M01283006' =>	'利用金額書式不正',
      'M01272001' =>	'売上対象種別未入力',
      'M01272008' =>	'売上対象種別書式不正'
    }.freeze
